<template>
  <div class="table-responsive">
    ...
    <el-table :data="items" border style="width:100%;">
      ...
      <el-table-column prop="createMobile" label="联系方式"></el-table-column>
      ...
      <el-table-column label="操作" width="210">
        <template slot-scope="scope">
          <button class="btn btn-sm btn-primary mr-2" :mid="scope.row.fbId" @click="showCheck">查看</button>
          <button class="btn btn-sm btn-warning mr-2" :mid="scope.row.fbId" @click="showEdit">编辑</button>
          <button class="btn btn-sm btn-danger mr-2" :mid="scope.row.fbId" @click="showDel">删除</button>
        </template>
      </el-table-column>
    </el-table>
    <input type="hidden" id="o_id">
    <input type="hidden" id="o_refresh" v-model="refresh">
    <Pagination
      v-show="currentPage"
...
<script>
import Check from "./opinion_check.vue"
